...
namespace DomOffline.Controllers
{
    public class PlayerInGamesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,GameId,PlayerId")] PlayerInGame playerInGame)
        {
            ...
            ViewBag.PlayerId = new SelectList(db.Players, "Id", "Name", playerInGame.PlayerId);
            return View(playerInGame);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,GameId,PlayerId")] PlayerInGame playerInGame)
        {
            if (ModelState.IsValid)
            {
