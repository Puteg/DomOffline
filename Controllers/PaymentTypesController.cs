...
namespace DomOffline.Controllers
{
    public class PaymentTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Decription")] PaymentType paymentType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Decription")] PaymentType paymentType)
        {
            if (ModelState.IsValid)
            {
